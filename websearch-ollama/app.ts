...
const allowedDomains = [
  ...
  { name: 'nuxt', url: 'nuxt.com', scrappable: true },
...
const openaiService = new OllamaLocalService();
...
app.post('/api/chat', async (req, res) => {
  ...
  try {
    ...
    const completion = await openaiService.completion(allMessages, "llama3.2", false);
